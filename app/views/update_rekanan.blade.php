<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Ubah Rekanan</h3>
	</div>
	<div class="panel-body">
		<form action="" method="post" class="form-horizontal" id="form-rekanan" role="form">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="nama" class="form-control" name="nama" placeholder="Nama Divisi" value="{{$data->NAMA_REKANAN}}">
				</div>
			</div>
			<div class="form-group">
				<label for="alamat" class="col-sm-3 control-label">Alamat</label>
				<div class="col-sm-9">
					<textarea id="alamat" class="form-control" name="alamat" placeholder="Alamat Perusahaan">{{$data->ALAMAT_REKANAN}}</textarea>
				</div>
			</div>
			<div class="form-group">
				<label for="telp" class="col-sm-3 control-label">No. Telepon</label>
				<div class="col-sm-9">
					<input type="text" id="telp" class="form-control" name="telp" placeholder="No. Telepon" value="{{$data->TELP_REKANAN}}">
				</div>
			</div>
			<div class="form-group">
