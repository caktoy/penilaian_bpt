	...
	<div class="panel-body">
		<form action="" method="post" class="form-horizontal" id="form-indikator" role="form">
				...
				<div class="col-sm-9">
					<div class="input-group">
						<select class="form-control" id="jenis" name="jenis" required autofocus>
							...
							<option value="{{ $opt->ID_JENIS_INDIKATOR }}" @if($indikator->ID_JENIS_INDIKATOR === $opt->ID_JENIS_INDIKATOR) selected @endif>
								{{ $opt->JENIS_INDIKATOR }}
							</option>
							@endforeach
						</select>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="nama" class="form-control" name="nama" placeholder="Nama Indikator" value="{{$indikator->NAMA_INDIKATOR}}" required>
				</div>
			</div>
			<div class="form-group">
				<label for="bobot" class="col-sm-3 control-label">Bobot (%)</label>
				<div class="col-sm-9">
					<input type="text" id="bobot" class="form-control" name="bobot" placeholder="00.00" value="{{$indikator->BOBOT_INDIKATOR*100}}">
				</div>
			</div>
			<div class="form-group">
				<label for="ket" class="col-sm-3 control-label">Keterangan</label>
				<div class="col-sm-9">
					<textarea id="ket" class="form-control" name="ket" placeholder="Keterangan" rows="3">{{$indikator->KET_INDIKATOR}}</textarea>
				</div>
			</div>
			<div class="form-group">
