	...
	<div class="panel-body">
		<form action="" method="post" class="form-horizontal" id="form-range" role="form">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="nama" class="form-control" name="nama" placeholder="Keterangan" required>
				</div>
			</div>
			<div class="form-group">
				<label for="nilai" class="col-sm-2 control-label">Nilai</label>
				<div class="col-sm-10">
					<!--<input type="number" id="nilai" class="form-control" name="nilai" placeholder="1-5" required>-->
